...
![登录并进行分析](/images/区块链实验5-优化系统的实现与测试/8lZdFe.png)

经过一段时间的等待后，将可以在`Report`界面查看到安全分析结果

![查看分析结果](/images/区块链实验5-优化系统的实现与测试/8lZcef.png)

也可以点击上图 Log 记录中的链接进入 MythX Dashboard 查看详细结果

![详细分析结果](/images/区块链实验5-优化系统的实现与测试/8lZfYQ.png)

点击`Analysed Files`查看错误的详细位置与说明，然后更改源代码，重新测试，直到合约安全性达到自己想要的结果。

![迭代修改](/images/区块链实验5-优化系统的实现与测试/8lZoyq.png)
...
![访问控制合约检测结果](/images/区块链实验5-优化系统的实现与测试/8leP0K.png)
...
![ACC的安全问题](/images/区块链实验5-优化系统的实现与测试/8leZpd.png)
...
![request access authorized](/images/区块链实验5-优化系统的实现与测试/81cdmj.png)
![monitor access authorized](/images/区块链实验5-优化系统的实现与测试/81c6pT.png)
![request blocked](/images/区块链实验5-优化系统的实现与测试/81gC38.png)
![monitor request blocked](/images/区块链实验5-优化系统的实现与测试/81gK3T.png)
...
![request static check failed](/images/区块链实验5-优化系统的实现与测试/81gQvF.png)
![monitor static check failed](/images/区块链实验5-优化系统的实现与测试/81g8b9.png)
