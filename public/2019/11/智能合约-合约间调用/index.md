...
![compile](https://user-images.githubusercontent.com/26682846/68472178-e6294d00-025a-11ea-8b4b-41a53b471c18.png)

 然后首先部署Add合约，因为Main合约的部署需要Add的合约地址作为参数。切换到部署和运行选项卡，选择Add合约，点击`Deploy`，成功部署后，复制合约地址。

![deploy simple Add ](https://user-images.githubusercontent.com/26682846/68472256-0e18b080-025b-11ea-9a24-e324c82cd7b5.png)

然后重新选择Main合约，填入Add合约地址作为参数，点击部署按钮。

![deploy simple Main ](https://user-images.githubusercontent.com/26682846/68472285-1a047280-025b-11ea-8bb5-a1fb5c65574e.png)

测试合约间调用，由合约内容可知，Main合约中的Addnumber函数调用了Add合约的add5函数，传入参数为10，得到的结果应为15。展开左侧的`Deployed Contracts`，点击Addnumber进行调用，结果如下。

![call test](https://user-images.githubusercontent.com/26682846/68472220-f5a89600-025a-11ea-9d2a-b39c8e39a810.png)
...
![deploy comlex Add](https://user-images.githubusercontent.com/26682846/68472316-2d174280-025b-11ea-96a6-51af8dd4fd4c.png)

接着编译部署Main合约，复制Add合约地址作为初始化参数，部署后调用Addnumber函数测试

![deploy comlex Main](https://user-images.githubusercontent.com/26682846/68472331-399b9b00-025b-11ea-933f-8c03ff95c55a.png)
