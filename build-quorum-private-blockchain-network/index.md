...
![网络拓扑设计](/images/区块链实验2-Quorum区块链实验平台搭建/8l9ZqJ.png)
...
<img src="/images/区块链实验2-Quorum区块链实验平台搭建/8lCt6U.png" style="zoom: 80%;" />

点击`IPv4`选项卡，选择`Manual`，输入我们之前预先设计的IP`192.168.191.2`，子网掩码、网关和DNS都做相应的设置，然后点击应用。

<img src="/images/区块链实验2-Quorum区块链实验平台搭建/8lCDt1.png" style="zoom:80%;" />
