...
>
> 更多的看RFC：https://tools.ietf.org/html/rfc2616#section-9.5

**URL** 是请求资源的 URL，**版本**是指 HTTP 协议的版本，现在一般是 HTTP/1.1。以前面 1.1 小节提到的例子来说明，请求「清华大学院系设置」页面，其 HTTP 请求报文的开始行应当是
...
![浏览器查看TLS版本](/images/计算机网络-HTTP和HTTPS协议/浏览器查看TLS版本.png)
...
![](/images/计算机网络-HTTP和HTTPS协议/2641864607-5e11d65c74244.png)
...
![B站数字证书](/images/计算机网络-HTTP和HTTPS协议/B站数字证书.png)
...
![](/images/计算机网络-HTTP和HTTPS协议/epub_907764_181.jpg)
