...
<img src="https://picped-1301226557.cos.ap-beijing.myqcloud.com/epub_27600261_316.jfif" style="zoom:50%;" />
...
<img src="https://picped-1301226557.cos.ap-beijing.myqcloud.com/epub_27600261_319.jfif" style="zoom:50%;" />
...
<img src="https://picped-1301226557.cos.ap-beijing.myqcloud.com/epub_27600261_324.jfif" style="zoom: 50%;" />
...
<img src="https://picped-1301226557.cos.ap-beijing.myqcloud.com/epub_27600261_326.jfif" style="zoom:50%;" />

我们在求 next[j+1] 的时候可以考虑动态规划递推的办法

1. $t_k = t_j$：那么 next[j+1] = k+1，即相等前缀和后缀的长度比 next[j] 多1，如下图

   <img src="https://picped-1301226557.cos.ap-beijing.myqcloud.com/epub_27600261_327.jfif" style="zoom:50%;" />

2. $t_k \neq t_j$：那么回退找 next[k] = k' 的位置，比较 $t_{k'}$ 和 $t_j$ 是否相等

   <img src="https://picped-1301226557.cos.ap-beijing.myqcloud.com/epub_27600261_328.jfif" style="zoom:50%;" />

   如果相等，则 next[j+1] = k'' + 1，如果不相等，继续向前找，直到找到 next[i] = 0 停止

   <img src="https://picped-1301226557.cos.ap-beijing.myqcloud.com/epub_27600261_329.jfif" style="zoom:50%;" />
