...
- [x] ~~对食堂所有菜做一次划分，包括想吃的、健康的、不想吃的，没什么感觉的等，然后指定饮食计划~~
...
- [ ] 每年定个时间去眼镜店清洗眼镜
- [ ] 在银行租个保险箱，放遗嘱啊什么的小物品
- [x] 在房管局网站查询房子的实际数据（实测山西省需要在[山西省智慧建筑管理服务信息平台 (shanxi.gov.cn)](https://zjt.shanxi.gov.cn/SXJGPublic/HTML/Project_List)查询）
- [ ] 尝试 figma 这个软件
