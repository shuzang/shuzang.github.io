...
![被隔离在海上的钻石公主号](../../../static/images/书藏的生活周刊第 9 期/被隔离在海上的钻石公主号.jpg)
...
![Shizuku Edition](../../../static/images/书藏的生活周刊第 9 期/Shizuku Edition.png)

2、[dropIt](http://www.dropitproject.com/)

文件分类的利器，预设规则，将一堆文件拖到图标上就可以根据文件类型、创建时间等属性自动化地处理，包括移动到指定文件夹，压缩解压，重命名等。

![dropIt文件分类](../../../static/images/书藏的生活周刊第 9 期/dropIt文件分类.gif)
...
<img src="../../../static/images/书藏的生活周刊第 9 期/标准玛格丽特.jpg" alt="标准玛格丽特" style="zoom:25%;" />
...
![NECE分析法](../../../static/images/书藏的生活周刊第 9 期/NECE分析法.jpg)
