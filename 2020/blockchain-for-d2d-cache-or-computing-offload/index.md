...
![分类解决方案](https://picped-1301226557.cos.ap-beijing.myqcloud.com/%E5%88%86%E7%B1%BB%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88.png)
...
3. 再次重申第 2 部分提到的几个问题：移动设备的发现、任务卸载、任务调度与分配、安全与隐私、移动性和激励、资源管理；

4. 在区块链平台中接取任务的限制是，需要保证接任务的设备在有效的 D2D 通信范围内，这是需要设备的地理位置信息的，这是隐私信息，如果要保证隐私，就要加密，但是任务分发平台有需要根据地理位置信息进行比对计算，如果在不泄露隐私的情况下进行计算，唯一能想到的办法就是同态加密，但是同态加密的问题比较多；

5. 隐私问题包括哪些方面，是保证接任务的设备地理位置信息和 IP 只能被发任务的用户看到，还是连发任务的用户也不能知道；

6. 对需要 IP 的理解是 D2D 通信需要知道对方的 IP；

7. D2D 通信技术的理解包括蓝牙、5G；

8. 隐私的保护一般使用的都是对称或非对称密钥加密，因此，核心在于一个密钥分发协议的设计和在区块链中的实现，这一点可以参考论文[^huang2019towards]，一个关于移动设备在区块链中隐私的更详细讨论是论文[^zyskind2015decentralizing]；
...
![两条区块链关联](https://picped-1301226557.cos.ap-beijing.myqcloud.com/%E4%B8%A4%E6%9D%A1%E5%8C%BA%E5%9D%97%E9%93%BE%E5%85%B3%E8%81%94.png)
...
![Figure 2: overlay of smart home](https://picped-1301226557.cos.ap-beijing.myqcloud.com/54513763-4e0ce980-4993-11e9-9433-6c0ad7714b7b.png)
