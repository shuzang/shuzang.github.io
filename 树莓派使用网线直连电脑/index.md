...
![网络与共享中心](/images/树莓派使用网线直连电脑/3AXugP.png)

**设置网络共享**

点击`以太网3->属性->共享选项卡->双击“Internet协议版本4（TCP/IP)” –> 选择“使用下面的ip地址” `，填入后点击确认

![以太网3 IP设定](/images/树莓派使用网线直连电脑/3AXUg0.png)
