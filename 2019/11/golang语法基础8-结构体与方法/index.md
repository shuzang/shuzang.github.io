...
![结构体内存布局](https://user-images.githubusercontent.com/26682846/69634008-507c2300-108c-11ea-8044-f5a0985f145e.jpg)
...
因为方法是函数，所以方法同样不允许重载，但不同的接收者变量可以有相同名字的方法，及时它们在同一个包中，一个例子如下
...
本文开始对结构体的介绍中，提到结构体对外部可见，而结构体中的字段对外部不可见是可能发送的，对于这种情况，读取或修改结构体中的字段值可以通过作用在结构体上的方法完成，一个例子如下
