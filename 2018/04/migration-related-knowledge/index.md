...
![1977年以来的Linux shell](/images/系统移植1-移植相关知识/41342748db2b.gif)
...
![u-boot源代码目录树](/images/系统移植1-移植相关知识/be4a61b7d1d7.png)

主要目录的作用列一个表如下：

![主要目录作用](/images/系统移植1-移植相关知识/dab6588a58c1.png)
...
![编译完成得到的文件](/images/系统移植1-移植相关知识/755481c360ac.png)
...
![u-boot工具](/images/系统移植1-移植相关知识/7fd06fbc33d3.png)
...
![串口终端显示的u-boot启动信息](/images/系统移植1-移植相关知识/5a239c8a9488.png)
...
![查看环境变量](/images/系统移植1-移植相关知识/c5f55503ce10.png)

下表列出一些常用的环境变量的含义解释

![img](/images/系统移植1-移植相关知识/68caba4bb42c.png)
...
![常用工具](/images/系统移植1-移植相关知识/f12ee86dc76e.png)
