...
![创建并切换分支](/images/系统移植2-Debian系统的移植/d1bb18bcb403.png)
...
![build-essential的依赖关系](/images/系统移植2-Debian系统的移植/8135c2d310f2.png)
...
![生成配置文件](/images/系统移植2-Debian系统的移植/c22b1be42612.png)
...
![编译通过](/images/系统移植2-Debian系统的移植/967c5a8d8bba.png)
...
![github上的工程](/images/系统移植2-Debian系统的移植/fd26ed77a3ab.png)
...
![lozp：not fountd](/images/系统移植2-Debian系统的移植/5665b6610702.png)
...
![四条指令](/images/系统移植2-Debian系统的移植/57171204afb8.png)

会有一些warning，但不碍事

![warning](/images/系统移植2-Debian系统的移植/ad7eeaabb67f.png)

要等很久.....

![编译成功](/images/系统移植2-Debian系统的移植/cc3a1d8404d3.png)
...
![zImage](/images/系统移植2-Debian系统的移植/beb1c3962a3d.png)

imx6dl-blurr.dtb直接从上面目录里的dts点进去

![imx6dl-blurr.dtb](/images/系统移植2-Debian系统的移植/6488bacf69de.png)
...
2. 安装xorg和KDE，KDE新版本叫plasma
   ...
   ![plasma-desktop](/images/系统移植2-Debian系统的移植/ff04dfdcef82.png)
...
![查看挂载地址](/images/系统移植2-Debian系统的移植/e2b342bb2c91.png)
...
![](/images/系统移植2-Debian系统的移植/0b65803507c5.png)

#### 删除原有分区

输入m可以获取帮助，显示所有可用命令。先用d 命令删除原来的分区，提示Selected partition，在后面输入要删除的分区号，回车，分区即可删除成功

![删除分区](/images/系统移植2-Debian系统的移植/image-20200427153230942.png)
...
![分区](/images/系统移植2-Debian系统的移植/bd06ff3756c8.png)

p命令查看分区信息，看是否符合预想。w命令保存退出。弹出重新插入SD卡或者重新启动Ubuntu系统，之后再次查看分区信息，这是为了更新分区表给内核，否则看不到分好的区。

![再次查看](/images/系统移植2-Debian系统的移植/b3f7856930ad.png)
...
![](/images/系统移植2-Debian系统的移植/81816c5f55ca.png)
...
![格式化分区](/images/系统移植2-Debian系统的移植/823a55d4bfef.png)
...
![](/images/系统移植2-Debian系统的移植/image-20200427154449772.png)
...
![](/images/系统移植2-Debian系统的移植/image-20200427154551645.png)
...
1. 靠近 HDMI接口的地方有个开关，拨动开关到boot一端，设置八位红色开关为0100001
   ...
   ![](/images/系统移植2-Debian系统的移植/image-20200427155128647.png)
...
5. 打开putty，选择serial，将COM1改成上面设备管理器里看到的COM号，speed改为115200，然后最下面点open
   ...
   ![](/images/系统移植2-Debian系统的移植/image-20200427155359810.png)
...
6. 此时看到串口输出（若没有，请按开发板HDMI口旁边的RESET按钮），按回车进入调试模式，输入如下命令命令
   ...
   ![](/images/系统移植2-Debian系统的移植/image-20200427155557593.png)

开发板上电，如果SD卡中此时只有u-boot和内核，屏幕上会有两只企鹅，

<img src="/images/系统移植2-Debian系统的移植/stickpicture.png" alt="显示企鹅" style="zoom:33%;" />
...
![](/images/系统移植2-Debian系统的移植/image-20200427160233842.png)
...
![](/images/系统移植2-Debian系统的移植/image-20200427160245617.png)

![](/images/系统移植2-Debian系统的移植/image-20200427160256212.png)
