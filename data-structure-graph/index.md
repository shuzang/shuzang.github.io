...
![一个无向图的例子](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8Y0u9K.png)
...
![图的邻接矩阵表示](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8Y03Bd.png)

实际编程时，通常使用二维数组的形式存储。对于无向图而言，邻接矩阵是对称的，因此通过只存储下三角矩阵或上三角矩阵的形式，可以节省一半的存储空间（矩阵压缩）。无向图的度是对应行（或列）非0元素的个数。

![下三角邻接矩阵](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8Y0U9f.png)
...
![](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8LUHQU.png)
...
![](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8LUxF1.png)
...
![十字链表](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8LIyse.png)
...
![](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8Lq6L8.png)
...
![图的邻接矩阵表示](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8Y03Bd-1585138053043.png)
...
![](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8yn7VA.png)
...
![拓扑排序](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8yKVYt.png)
...
![](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8y1p4A.png)

假设一个工程的 AOE 网如下，最常求的就是 a) 整个工程完工需要多长时间？ b) 哪些活动影响工程进度？或求关键路径。图中的虚线表示事件有先后关系，但是这个活动不存在。

![AOE网络](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8y3Exx.png)
...
![Kruskal算法](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8IP2RI.png)
...
![Prim算法](https://picped-1301226557.cos.ap-beijing.myqcloud.com/8IFD4H.png)
